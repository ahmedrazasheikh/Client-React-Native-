...
<Text>Total Scale:    <Text     style={styles.Id}    >167,987 Riyal </Text>   </Text>
<Text>Rank :    <Text     style={styles.Id2}    >22nd </Text>   </Text>
...
<Text> Option:     <Text     style={styles.Id5}    >Value  </Text>   </Text>
